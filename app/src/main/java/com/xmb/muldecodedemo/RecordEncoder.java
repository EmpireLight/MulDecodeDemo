...
public class RecordEncoder implements Runnable {
    private final static String TAG = "RecordEncoder";
    ...
    class EncoderHandler extends Handler {
        ...
        private WeakReference<RecordEncoder> mWeakEncoder;

        public EncoderHandler(RecordEncoder encoder) {
            mWeakEncoder = new WeakReference<RecordEncoder>(encoder);
        }

        @Override
        public void handleMessage(Message msg) {
            RecordEncoder encoder = mWeakEncoder.get();
            if (encoder == null) {
            ...
            switch (what) {
                case MSG_START_RECORDING:
                    encoder.handleStartRecording((RecordEncoder.EncoderConfig) obj);
                    break;
    ...
    private PassThroughFilter mFBOFrameRect;
    ...
    private void handleFrameAvailable(float[] transform, long timestampNanos) {
        ...
        mFBOFrameRect.onDrawFrame(mFrameTextureId);
